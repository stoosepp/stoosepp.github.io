var jsPsychSurveyMultiChoice = (function (jspsych) {
  ...
  class SurveyMultiChoicePlugin {
    ...
    trial(display_element, trial) {
      ...
      html +=
        ".jspsych-survey-multi-choice-question {display: flex; flex-direction:column; align-items:center}  .jspsych-survey-multi-choice-option { line-height: 2;   display:block; text-align:left; width:50%; } .jspsych-survey-multi-choice-option label {display: flex; align-items: center; text-align: left;} .jspsych-survey-multi-choice-text .jspsych-survey-multi-choice-option input[type='radio'] { margin-right: 8px; flex-shrink: 0;} ";
      ...
      document.querySelector("form").addEventListener("submit", (event) => {
        ...
        for (var i2 = 0; i2 < trial.questions.length; i2++) {
          var match = display_element.querySelector(
            "#jspsych-survey-multi-choice-" + i2
          );
          var id = "Q" + i2;
          var val;
